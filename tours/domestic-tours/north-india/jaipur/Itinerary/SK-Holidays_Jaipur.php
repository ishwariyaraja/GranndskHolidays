      ...
      <div id="carouselExampleSlidesOnly" class="carousel slide d-flex" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../Jaipur3.jpg" class="d-block w-100" alt="...">
          </div>
        </div>
      </div>    
        </div>
            ...
            <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -20%" data-bs-smooth-scroll="true" class="scrollspy-example bg-body-tertiary p-3 rounded-2" tabindex="0" style="border: 1px solid navajowhite;">
              ...
              <h4>Itinerary:</h4>
                  <ul style="text-align: justify;">
                      <li><b>DAY 1:</b></li>
                      <p>Pickup from Delhi Airport, Railway Station, Bus Stand and drive to Jaipur, Arrive Jaipur Transfer to hotel for installation. Visit to Birla temple, Nahargarh Fort sunset view over city. Evening visit Overnight at hotel.</p>
                      <li><b>DAY 2:</b></li>
                      <p>Morning tour of Jaipur. Jaipur Rajasthan was given a colour coat of pink a century ago in honour of a visiting Prince. Built by Maharaja Jai Singh, the notable astronomer, this city is 260 years old. Visit Maharaja's City Palace, & the Observatory . Drive past Hawa Mahal & through the pink rose residential & business areas. Afternoon free. Overnight Jaipur. Places to be visited in Jaipur: City Palace, Jantar Manatar, Hawa Mahal & Local Market.</p>
                      <li><b>DAY 3:</b></li>
                      <p>After breakfast, the day is free until transferred to Airport for your onward journey to the next destination.</p>
