      ...
      <div id="carouselExampleSlidesOnly" class="carousel slide d-flex" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../Darjeeling3.jpg" class="d-block w-100" alt="...">
          </div>
        </div>
      </div>    
        </div>
            ...
            <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -20%" data-bs-smooth-scroll="true" class="scrollspy-example bg-body-tertiary p-3 rounded-2" tabindex="0" style="border: 1px solid navajowhite;">
              ...
              <h4>Itinerary:</h4>
                  <ul style="text-align: justify;">
                      <li><b>DAY 1: Bagdogra to Darjeeling</b></li>
                      <p>Welcome on arrival at New Jalpaiguri Rly Station / Bagdogra Airport & transfer to Darjeeling at an altitude of 6700ft (75km, approx 3hrs hill Drive) via the pretty Hill Station Kurseong. Take a tea break at Kurseong and proceed through Hill cart road playing hide & seek along with very nostalgic Darjeeling Himalayan Railways. The narrow gauge (2ft width) �Toy train� track, passing over the station�s like Tung, Sonada and Ghoom and reach at one of the most magnificent hill resorts in the world, check in at hotel, Evening free for enjoy walking tour or pony ride at �Mall� area or just see the color full lifestyle of local hill people�s in the mall area, Overnight at hotel.</p>
                      <li><b>DAY 2: Darjeeling Sightseeing</b></li>
                      <p>Be ready early morning, at approx 4.00am you will be pick up for visit Tiger Hill (24km hill drive) at an altitude of 8500ft for spectacular view of color full sunrise over Mt. Khangchendzonga (Subject to weather condition), on way back visit Ghoom Monastery, Batasia Loop . After breakfast visit Himalayan Mountaineering Institute, Padmaja Naidu Zoological Park (both are closed on Thursday) Tenzing Rock, Ropeway view point (Ropeway ride on own cost) Tibetans Refuge handicraft Centre (closed on Sunday), Happy valley Tea Garden (outer view), Peace Pagoda & back to hotel.</p>
                      <li><b>DAY 3:  Darjeeling Sightseeing</b></li>
                      <p>After breakfast go for a excursion trip to Mirik (40km hill drive) a picturesque place, nestled in Pine and Conifer forested hills at an altitude of 5800ft, it is famous for its Sumendu Lake known as �Mirik Lake� surrounded by tea estates .one can enjoy boating at lake (by own cost) . On return take a break at Indo- Nepal Border �Pashupati� take a walk at in side of neighbour country Nepal (Only Indian Citizens allowed) and back to Darjeeling. Stay in Darjeeling.</p>
                      <li><b>DAY 4: Airport Drop</b></li>
                      <p>Morning free for packing, after breakfast transfer to New Jalpaiguri Rly Station or Bagdogra Airport for your return journey.</p>
                  </ul>  
            </div><hr>
          ...
          <div class="col-lg-4 d-flex align-items-center basic_pack">
            ...
            <div class="col">
                <div class="card text-center mb-3 package-card">
                    <div class="card-body">
                      <h3 class="card-title">DARJEELING</h3>
                      <p class="card-text"><b>3 Nights / 4 Days</b></p>
                       <!-- row -->
      <nav class="container" aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
          <li class="breadcrumb-item active" aria-current="page">Darjeeling </li>
        </ol>
      </nav>
