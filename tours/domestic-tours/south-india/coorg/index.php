...
<!-- coorg Packages -------------------------------------------------------------------------------------------->
    ...
    <div class="col-lg-4 col-md-6 col-sm-12" style="display:flex; justify-content:center; align-items:center; margin:auto;"><div class="card">
      ...
      <div class="card-content">
        <h5>GRAND SK Holidays-India-Coorg Basic Pack</h5>
          <h4 class="card-title">Trip to Coorg & Mysore </h4><hr>
          <div class="vl">
          ...
          <!-- modal -->
           <!-- Button trigger modal -->
            <div class="container d-flex justify-content-center">
              <a href="../coorg/Itinerary/coorg2n3dbasic.php"><button type="button" class="btn btn-primary" data-bs-toggle="modal">View Itinerary </button></a>
</div></div>
    </div></div>
...
<!-- standard -->
    <div class="col-lg-4 col-md-6 col-sm-12" style="display:flex; justify-content:center; align-items:center; margin:auto;"><div class="card">
      ...
      <div class="card-content">
        <h5>GRAND SK Holidays-India-Coorg Standard Pack</h5>
        <div style="display: flex; justify-content: space-between;">
          <h4 class="card-title">Trip to Coorg & Mysore </h4>        
          </div><hr>
          <div class="vl">
              <div class="row d-flex align-items-start">
                <div class="col-2">
          ...
          <div class="container d-flex justify-content-center">
            <a href="../coorg/Itinerary/coorg2n3dstandard.php"><button type="button" class="btn btn-primary" data-bs-toggle="modal">View Itinerary</button></a>
          </div>
      </div>
    </div></div>
   ...
   <!-- Premium -->
    <div class="col-lg-4 col-md-6 col-sm-12" style="display:flex; justify-content:center; align-items:center; margin:auto;"><div class="card">
      ...
      <div class="card-content">
        <h5>GRAND SK Holidays-India-Coorg Premium Pack</h5>
        <div style="display: flex; justify-content: space-between;">
          <h4 class="card-title">Trip to Coorg & Mysore </h4>        
          </div><hr>
          <div class="vl">
          ...
          <div class="container d-flex justify-content-center">
            <a href="../coorg/Itinerary/coorg2n3dpremium.php"><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal2">View Itinerary</button></a>
            </div>
      </div>
    </div></div>
      ...
      <div class="card-content">
        <h5>GRAND SK Holidays-India-Coorg Basic Pack</h5>
          ...
          <!-- modal -->
           <!-- Button trigger modal -->
            <div class="container d-flex justify-content-center">
              <a href="../coorg/Itinerary/coorg_basics.php"><button type="button" class="btn btn-primary" data-bs-toggle="modal">View Itinerary </button></a>
</div></div>
    </div></div>
    ...
    <div class="col-lg-4 col-md-6 col-sm-12" style="display:flex; justify-content:center; align-items:center; margin:auto;"><div class="card">
      ...
      <div class="card-content">
        ...
        <div style="display: flex; justify-content: space-between;">
          ...
          <div class="container d-flex justify-content-center">
            <a href="../coorg/Itinerary/coorg_standard.php"><button type="button" class="btn btn-primary" data-bs-toggle="modal">View Itinerary</button></a>
          </div>
      </div>
    </div></div>
    ...
    <div class="col-lg-4 col-md-6 col-sm-12" style="display:flex; justify-content:center; align-items:center; margin:auto;"><div class="card">
      ...
      <div class="card-content">
        ...
        <div style="display: flex; justify-content: space-between;">
          ...
          <div class="container d-flex justify-content-center">
            <a href="../coorg/Itinerary/coorg_Premium.php"><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal2">View Itinerary</button></a>
            </div>
      </div>
    </div></div>
...
<div class="container" style="margin-top: 35px;">
  <h1>FAQ - Coorg Trip</h1>
  <div class="faq">
      <div class="faq-item">
          <h2 class="faq-question">1. When is the best time to visit Coorg?</h2>
          <div class="faq-answer">
              <p>The best time to visit Coorg is from October to March, when the weather is cool and ideal for sightseeing and outdoor activities.</p>
          </div>
      </div>

      <div class="faq-item">
          <h2 class="faq-question">2. What are the must-visit places in Coorg?</h2>
          <div class="faq-answer">
              <p>Top attractions include Abbey Falls, Raja's Seat, Dubare Elephant Camp, Talacauvery, Namdroling Monastery, and coffee plantations.</p>
          </div>
      </div>

      <div class="faq-item">
          <h2 class="faq-question">3. What activities can I do in Coorg?</h2>
          <div class="faq-answer">
              <p>Popular activities include trekking, river rafting, coffee estate tours, nature walks, bird watching, and visiting temples and monasteries.</p>
          </div>
      </div>

      <div class="faq-item">
          <h2 class="faq-question">4. How do I reach Coorg?</h2>
          <div class="faq-answer">
              <p>Coorg does not have its own airport or railway station. The nearest airport is in Mangalore or Kannur, and the nearest railhead is in Mysore. From there, taxis or buses can take you to Coorg.</p>
          </div>
      </div>

      <div class="faq-item">
          <h2 class="faq-question">5. What are the accommodation options in Coorg?</h2>
          <div class="faq-answer">
              <p>Coorg offers a range of stays including luxury resorts, budget hotels, homestays, and nature lodges amidst coffee plantations.</p>
          </div>
      </div>

      <div class="faq-item">
          <h2 class="faq-question">6. Do I need any permits to visit Coorg?</h2>
          <div class="faq-answer">
              <p>No permits are required for Indian or foreign tourists to visit Coorg.</p>
          </div>
      </div>
      ...
      <div class="faq-item">
          ...
          <div class="faq-answer">
              <p>Coorgi cuisine is known for its spicy and flavorful dishes. Must-tries include pandi curry (pork curry), bamboo shoot curry, and akki roti (rice roti).</p>
          </div>
      </div>
      ...
      <div class="faq-item">
          ...
          <div class="faq-answer">
              <p>Carry mosquito repellent, basic medication, and stay hydrated. Wear appropriate footwear for trekking and walking on rough terrain.</p>
          </div>
      </div>

      <div class="faq-item">
          <h2 class="faq-question">9. Is Coorg safe for solo or family travel?</h2>
          <div class="faq-answer">
              <p>Yes, Coorg is considered safe for both solo and family travelers. Standard travel precautions are recommended as always.</p>
          </div>
      </div>
      ...
      <div class="faq-item">
          ...
          <div class="faq-answer">
              <p>The local currency is the Indian Rupee (INR). While cards are accepted in most towns, it's advisable to carry cash in remote areas.</p>
          </div>
      </div>

      <div class="faq-item">
          <h2 class="faq-question">11. How do I get around Coorg?</h2>
          <div class="faq-answer">
              <p>You can hire cabs, self-drive cars, or use local jeeps. Public transport is limited, so private transport is recommended for sightseeing.</p>
          </div>
      </div>

      <div class="faq-item">
          <h2 class="faq-question">12. What should I pack for my Coorg trip?</h2>
          <div class="faq-answer">
              <p>Pack light woolens (especially in winter), rain gear (if visiting during monsoon), trekking shoes, insect repellent, and comfortable clothing.</p>
          </div>
      </div>
  </div>
</div>
