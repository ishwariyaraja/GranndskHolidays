      ...
      <div id="carouselExampleSlidesOnly" class="carousel slide d-flex" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../Kerala4.jpg" class="d-block w-100" alt="...">
          </div>
        </div>
      </div>    
        </div>
              ...
              <h4>Itinerary:</h4>
                  <ul style="text-align: justify;">
                    <li><b>DAY 1: Cochin to Munnar</b></li>
                      ...
                      <li><b>DAY 3:  Munnar to Alleppey</b></li>
                      <p>Morning proceeds to Alleppey. Alleppey a charming village on the Vembanad Lake. The land is known for its azure backwaters, swaying palms, and floating houseboats. enjoy the backwater sightseeing at own cost and evening visit Alleppey Beach. Overnight at Houseboat in Alleppey.</p>
                      <li><b>DAY 4:  Alleppey to Cochin</b></li>
                      <p>Morning disembarks from the Hotel. Bid farewell to this serene land as your holidays come to an end as you get transferred to Cochin Airport or Ernakulam Railway Station for your onward journey back home.</p>
                  </ul>  
            </div><hr>
