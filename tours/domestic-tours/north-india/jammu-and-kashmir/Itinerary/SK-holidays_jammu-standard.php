...
<!-- ===== CONTENT ===== -->
        <div class="container-fluid" style="background-color: white; width:100%;">
          ...
          <div class="logo_cont" style="width:30%; margin:0px;">
            
            
            <!-- <a class="navbar-brand"  href="#">SK Holidayss</a> -->
          </div>
          
          <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarTogglerDemo" aria-controls="navbarTogglerDemo01" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
          </button>
          <div class="menu_bar collapse navbar-collapse" style="width:40%;" id="navbarTogglerDemo">
            <ul class="nav justify-content-end">
              <li class="nav-item">
                <a class="nav-link" aria-current="page" href="./index.php">HOME</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">GROUP TOUR</a>
              </li>
              <li class="nav-item">
                <div class="dropdown">
                  <a class="nav-link btn dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">TOURS</a>
              ...
              <li class="nav-item">
                <a class="nav-link" href="/Spiritual/Spiritual.php">SPIRITUAL TOUR</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="/Honeymoon/Honeymoon.php">HONEYMOON</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item"><a class="nav-link" href="#" style="text-decoration:none; color:Navy; margin:auto;">Agent Login</a></li>
            </ul>
          </div>
      ...
      <div id="carouselExampleSlidesOnly" class="carousel slide d-flex" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../Jammu.jpg" class="d-block w-100" alt="...">
          </div>
        </div>
      </div>    
        </div>
          ...
          <div class="col-lg-7 d-flex cont">
            ...
            <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -20%" data-bs-smooth-scroll="true" class="scrollspy-example bg-body-tertiary p-3 rounded-2" tabindex="0" style="border: 1px solid navajowhite;">
              ...
              <ul style="text-align: justify;">
                <li><b>DAY 1:  Arrival at Srinagar Airport</b></li>
                      <p>Transfer to Srinagar check-in to the hotel. After relaxing, enjoy Srinagar Mughal Gardens: Nishat (The garden of Delight), Shalimar (The Garden of love), Chashma - Shahi (The Royal Spring), and Kashmir Largest Almond Garden and evening transfer to Srinagar Hotel and overnight stay in Srinagar Hotel.</p>
                      <li><b>DAY 2: Srinagar � Sonamarg - Srinagar</b></li>
                      <p>Full day tour of Sonamarg: 87km from Srinagar, 3 hours journey, 2800mts above sea level. It is called: Golden meadow �At the head of the river Sing with beautiful mountains and glaciers. The resort is surrounded by many places of interest Places like Thajiwas Glacier and Zero Point. One can enjoy this By Pony or Local Union Cab on Direct Payment Basis. And Overnight stay at Srinagar in the hotel.</p>
                      <li><b>DAY 3: Srinagar � Gulmarg - Srinagar</b></li>
                      <p>After Breakfast transfer to Gulmarg, Via Tangmarg check-in to the Hotel. After relax enjoy GULMARG: The meadow of flowers� 56kms from Srinagar 2690mts above the sea level. This is also India�s premier Ski resort in winter and also has the world's highest golf course. Gulmarg is famous for winter sports and Gondola cable car ride the world's highest cable car One and enjoy this on direct payment Basis and Overnight Stay at Srinagar in Hotel.</p>
                      <li><b>DAY 4: Srinagar � Pahalgam</b></li>
                      <p>After Breakfast transfer to PAHALGAM: The popular holiday resort, 95km East of Srinagar 2400 meters above the sea level. The town of Pahalgam (Village of Shepherds) offers breath-taking views of alpine peaks, the Lidder and Seshnag Rivers tumbling down picturesque, deep-cut mountain valleys. It is also the entry point for the famous Amarnath Cave, a holy site for Hindus. On your way, you would visit the Avantipur Ruins the 1100-year-old temple dedicated to Lord Vishnu.</p>
                      <li><b>DAY 5: Pahalgam � Srinagar</b></li>
                      <p>After Breakfast transfer to Srinagar and visit of HISTORICAL PLACES: Hazratbal, Shankaracharya temple Jamia Masjid and Parimahal and Evening enjoy 01 Hour Shikara Ride in Dal Lake Complementary and Overnight Stay at Srinagar in Houseboat.</p>
                      <li><b>DAY 6: Departure to Srinagar Airport</b></li>
                      <p>After breakfast departure to Srinagar Airport for your onward Destination.</p>
              </ul>
            </div><hr>
          ...
          <div class="col-lg-4 d-flex align-items-center basic_pack">
            ...
            <div class="col">
                <div class="card text-center mb-3 package-card">
                    <div class="card-body">
                      <h3 class="card-title">Jammu & Kashmir</h3>
