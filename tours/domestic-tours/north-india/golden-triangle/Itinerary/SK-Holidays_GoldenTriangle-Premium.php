      ...
      <div id="carouselExampleSlidesOnly" class="carousel slide d-flex" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../Golden_triangle.png" class="d-block w-100" alt="...">
          </div>
        </div>
      </div>    
        </div>
          ...
          <div class="col-lg-7 d-flex cont">
            ...
            <ul style="text-align: justify;">
                      <li><b>DAY 1: Arrival at Delhi local sight seeing</b></li>
                      <p>Meet & Greet on arrival at Delhi Airport &
transfer to visit Red Fort, Raj Ghat, Humayun’s
Tomb, Rastrapati Bhawan, Parliament House,
Jantar Mantar & India Gate. Overnight stay at
Delhi.</p>
                      <li><b>DAY 2: Delhi – Agra Sightseeing</b></li>
                      <p>After Breakfast drive to Mathura Krishna
temple darshan and proceed another
historical and romantic city - Agra. Afternoon
visit the world-famous Taj Mahal - the most
precious gift of love built by Emperor Shah
Jahan for his loving wife Mumtaz and Also
visit the Marble inlay making factories to see

traditional workers making amazing marble crafts. Overnight stay at Agra.</p>
                      <li><b>DAY 3:Agra – Jaipur via Fatehpur Sikri</b></li>
                      <p>After breakfast visit Agra Fort & proceed to
the Pink City of Jaipur. En-route visit Fatehpur
Sikri - once the capital of Mughal Emperor
Akbar. On arrival at Jaipur, check into your
hotel. Overnight stay at Jaipur.</p>
                      <li><b>DAY 4: Jaipur Local Sightseeing</b></li>
                      <p>After breakfast start for full day local
sightseeing in Jaipur. Visit Amber Fort &
Palace, "Gaitore" Ce netophs (Front View),
take a photo stop at Jal Mahal, City Palace
& Museum, Jantar Mantar (Observatory) &
take a photo stop at Hawa Mahal. Evening
free for leisure. Overnight stay at Jaipur.</p>
                      <li><b>DAY 5:Jaipur - Delhi Departure </b></li>
                      <p>Morning after breakfast check out from the
hotel, Transfer to Delhi Airport for onward
journey.</p>
                  </ul>  
            </div><hr>
          ...
          <div class="col-lg-4 d-flex align-items-center basic_pack">
            ...
            <div class="col">
              <div class="card text-center mb-3 package-card">
                <div class="card-body">
                  <h3 class="card-title">GOLDEN TRIANGLE</h3>
                  <p class="card-text"><b>4 Nights / 5 Days</b></p>
                   <!-- row -->
      <nav class="container" aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
          <li class="breadcrumb-item active" aria-current="page">Golden Triangle</li>
        </ol>
      </nav>
