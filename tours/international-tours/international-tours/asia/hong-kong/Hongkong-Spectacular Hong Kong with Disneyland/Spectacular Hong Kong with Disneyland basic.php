            ...
            <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -20%" data-bs-smooth-scroll="true" class="scrollspy-example bg-body-tertiary p-3 rounded-2" tabindex="0" style="border: 1px solid navajowhite;">
              ...
              <h4>Itinerary:</h4>
                  <ul style="text-align: justify;">
                      <li><b>Day 1: Arrival in Hong Kong</b></li>
...
<li><b>Day 2: Hong Kong Night Tour</b></li>
<p>After breakfast, the day free for you to explore as you like. In the evening, start the tour by visiting The Waterfront Promenade from where you can have unparalleled views of the Victoria Harbour. Next on your tour is a visit to the Jewellery factory and the cultural Aberdeen fishing village to view the contrasting image of the quaint yet modern Hong Kong. End the exciting day by visiting the spectacular Victoria peak. It offers awe-inspiring views of Hong Kong's cityscape. Return to the hotel for a comfortable overnight stay.</p>
          ...
          <div class="col-lg-4 d-flex align-items-center basic_pack">
            ...
            <div class="col">
                <div class="card text-center mb-3 package-card">
                    <div class="card-body">
                      <h3 class="card-title"> Hong kong Disneyland </h3>
                      <p class="card-text"><b>4 Nights /5 Days</b></p>
        <ol class="breadcrumb">
          <!-- <li class="breadcrumb-item"><a href="index.php">Home</a></li> -->
          <li class="breadcrumb-item"><a href="../index.php"> Hongkong Home</a></li>
          <li class="breadcrumb-item" aria-current="page"> Hong kong Disneyland</li>
        </ol>
