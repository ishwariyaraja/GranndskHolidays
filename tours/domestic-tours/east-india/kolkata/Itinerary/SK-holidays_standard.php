            ...
            <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -20%" data-bs-smooth-scroll="true" class="scrollspy-example bg-body-tertiary p-3 rounded-2" tabindex="0" style="border: 1px solid navajowhite;">
              ...
              <h4>Itinerary:</h4>
                  <ul style="text-align: justify;">
                    <li><b>DAY 1: Bhubaneswar � Puri</b></li>
                    <p>Assistance upon arrival at Bhubaneswar and transfer to Puri. Check in to the hotel. Half day sightseeing includes 12th century Jagannath Temple (one of the four dhams), Sonar gaurang temple, Swargadwar .Evening can be spent on the beach. Overnight stay will be at Puri.</p>
                    <li><b>DAY 2: Puri � Satapara (Chilka) � Puri</b></li>
                    <p>After breakfast drive to Chilka. Arrival Satapara meets the Irrawaddy Dolphins in nature and the Hrada-Sagar Sangam or the sea mouth (the point where the lake meets the sea). Enjoy the day at Chilka Lake (India�s biggest inland lake spread over 1,100 square kilometers). Drive back to Puri. Overnight stay will be at Puri.</p>
                    <li><b>DAY 3: Puri � Konark � Bhubaneswar</b></li>
                    <p>After Early breakfast drive to Bhubaneswar via Konark. Arrive Konark to witness the 13th century Sun temple and chandra vaga sea beach. Then drive to Bhubaneswar En-route visit Pipplli, Dhaulagiri, 11th century Lingaraj Temple, 8th century mukteswar temple, and Rajarani temple. Overnight stay will be at Bhubaneswar.</p>
                    <li><b>DAY 4: Bhubaneswar</b></li>
                    <p>After breakfast drive to Khandagiri & Udayagiri . Then drive to wildlife park Nandan kanan. Overnight stay will be at Bhubaneswar.</p>
                    <li><b>DAY 5: Bhubaneswar � Departure</b></li>
                    <p>Morning will be free for packing & personal activities. Check out from hotel and drive to airport.</p>
                  </ul>  
            </div><hr>
      ...
      <div style="padding: 10px; border-radius: 5px; ">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Kolkata </li>
                      ...
                      <!-- <p class="card-text">Howrah-1 Night, Dakhineswar-1 Night, Gangasagar-2 Nights</p> -->
