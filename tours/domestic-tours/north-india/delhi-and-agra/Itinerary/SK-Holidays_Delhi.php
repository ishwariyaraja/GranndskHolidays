      ...
      <div id="carouselExampleSlidesOnly" class="carousel slide d-flex" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../Delhi4.jpg" class="d-block w-100" alt="...">
          </div>
        </div>
      </div>    
        </div>
          ...
          <div class="col-lg-7 d-flex cont">
            <div id="navbar-example2 itenary" class="navbars bg-body-tertiary px-3 mb-3 justify-content-center">
            ...
            <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -20%" data-bs-smooth-scroll="true" class="scrollspy-example bg-body-tertiary p-3 rounded-2" tabindex="0" style="border: 1px solid navajowhite;">
              ...
              <h4>Itinerary:</h4>
                  <ul style="text-align: justify;">
                      <li><b>DAY 1 : MADURAI TO DELHI </b></li>
                      <p>On arrival at Delhi airport. Our representative having a placard displaying your name will meet you at the airport to pick you up and you will visit Jama Masjid-the country�s largest mosque. Afternoon 2.00 PM Check-in hotel. After little bit rest, transfer to Chandni Chowk and spice market & enjoy Rickshaw Ride in Chandni chowk, then visit the elegant but imposing Red Fort, Raj Ghat-a memorial to Mahatma Gandhi, Humayun�s tomb-Delhi�s finest example of Mughal architecture, the famous Lotus Temple of the Baha�i faith, the medieval workmanship of Qutub Minar, The Parliament House, The President House and India Gate. Rest of the day is free at your leisure. Overnight at the hotel in Delhi.</p>
                      <li><b>DAY 2: DELHI TO AGRA</b></li>
                      <p>This morning after breakfast you will be transferred to Mathura Krishna temple visit and Mughal city Agra. Agra is a major tourist destination in North India because of its many Mughal-era buildings, most notably the Taj Mahal, Agra Fort and Fatehpur Sikri, all these three are UNESCO World Heritage Sites. On arrival check in to your hotel. After fresh n up you will visit the famous Taj Mahal-the symbol of love, built by Emperor Shah Jahan in memory of his wife Mumtaz Mahal. (Taj Mahal Remains Closed on Every Friday) Later, visit the Agra fort, built by the great Emperor Akbar and the tomb of Etimad-ud-Daula often described as Jewel Box or the Baby Taj and is regarded as a draft of the Taj Mahal. Rest of the day is free at your leisure. Overnight at the hotel in Agra.</p>
                      <li><b>DAY 3: AGRA � DELHI - TRICHY  </b></li>
                      <p>This early morning at sunrise you can visit the Taj Mahal-again (Optional visit). After visiting the Taj Mahal, return back to your hotel for fresh and breakfast. After breakfast you will be transferred to Delhi, Shopping at Delhi than drop at Delhi Airport at 07.00 Pm. Return back with lots of Sweet memories.</p>
          ...
          <div class="col-lg-4 d-flex align-items-center basic_pack">
            ...
            <div class="col">
                <div class="card text-center mb-3 package-card">
                    <div class="card-body">
                      <h3 class="card-title">DELHI & AGRA</h3>
                      <p class="card-text"><b>2 Nights / 3 Days</b></p>
                      <!-- row -->
      <nav class="container" aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
          <li class="breadcrumb-item active" aria-current="page">Delhi & agra</li>
        </ol>
      </nav>
