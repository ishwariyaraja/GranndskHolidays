      ...
      <div id="carouselExampleSlidesOnly" class="carousel slide d-flex" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../Kerala6.jpg" class="d-block w-100" alt="Munnar & Boat House-Vagamon">
          </div>
        </div>
      </div>    
        </div>
            ...
            <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -20%" data-bs-smooth-scroll="true" class="scrollspy-example bg-body-tertiary p-3 rounded-2" tabindex="0" style="border: 1px solid navajowhite;">
              ...
              <h4>Itinerary:</h4>
                  <ul style="text-align: justify;">
                    <li><b>DAY 1: Arrive at Cochin - Munnar</b></li>
                      <p>Arrive at Cochin, the gateway of Kerala, and proceed to Munnar to start your Kerala journey in the heaven of peace and harmony. This incredibly beautiful hill station is positioned at a height of 6000 ft. On the way visit Valara, Cheeyapara waterfalls, spices plantation visits and tea gardens. Check into the resort and overnight stay will be arranged in the Munnar resort/hotel.</p>
                      <li><b>DAY 2: Munnar Sightseeing</b></li>
                      <p>Morning after breakfast proceed to enjoy a full day Munnar local sightseeing covering Photo Point, Jungle Honey Bee Nest, Mattupetty Dam and boating, Elephant Arrival Spot, Echo Point and Munnar city. After lunch visit Tea Museum, Anaimudi View, Rajamala, Eravikulam National Park, Blossom Park, Pothamedu View, and enjoy the sunset view, Cardamom, Coffee and Pepper plantations. Overnight stay at hotel in Munnar.</p>
                      <li><b>DAY 3: Munnar to Vagamon</b></li>
                      <p>After breakfast, transfer to Vagamon. This incredibly beautiful hill station is positioned at a height of 3,900 ft. Visit Kurisumala Ashram, Murugan Hill, Vagamon Hill Town and Thangalpara. Return to the hotel and overnight stay at Vagamon.</p>
                      <li><b>DAY 4: Alleppey (Kumarakom) Kettuvallam</b></li>
                      <p>After breakfast, proceed to Alleppey/Kumarakom (Rice Bowl of Kerala). Set out on an enchanting overnight backwater cruise in a traditional Kerala houseboat after lunch. While cruising in these floating luxury vessels, enjoy the Kerala countryside and a beautiful village walk with the heart of nature. All meals including tea and snacks will be served on board. Overnight stay in the houseboat.</p>
                      <li><b>DAY 5: Departure</b></li>
                      <p>After breakfast check out from the hotel and drop at Cochin Railway Station or Airport. Return to hometown with sweet memories.</p>
                  </ul>  
            </div><hr>
          ...
          <div class="col-lg-4 d-flex align-items-center basic_pack">
            ...
            <div class="col">
                <div class="card text-center mb-3 package-card">
                    <div class="card-body">
                      <h3 class="card-title">Munnar &amp; Boat House-Vagamon</h3>
                      <p class="card-text"><b>4 Nights / 5 Days</b></p>
                      <!-- row -->
      <nav class="container" aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
          <li class="breadcrumb-item active" aria-current="page">Munnar &amp; Boat House-Vagamon</li>
        </ol>
      </nav>
