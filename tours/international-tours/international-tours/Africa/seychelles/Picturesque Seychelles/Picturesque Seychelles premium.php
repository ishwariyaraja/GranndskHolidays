...
<!-- ===== CONTENT ===== -->
  <div class="container-fluid package p-0">
    ...
    <li>
      <b>Day 3: Praslin and La Digue from Mahe</b> </li>
      <p>Relish an early morning breakfast at the resort. Ferry transfer to Praslin. Take a tour of the UNESCO World Heritage Site - Vallee de Mai - and visit the most beautiful beaches in the world.
      Then proceed towards exploration of the beautiful beaches of La Digue, and indulge in some beach and water activities (at an extra cost). Anse Source Dâ€™Argent beach is one of the most photographed beaches in the world. Enjoy sunset at the Anse Source Dâ€™Argent beach and head back to the hotel in Mahe.</p>
    

    <li>
      <b>Day 4: Departure</b> </li>
          ...
          <div class="col-lg-4 d-flex align-items-center basic_pack">
            ...
            <div class="col">
                <div class="card text-center mb-3 package-card">
                    <div class="card-body">
                      <h3 class="card-title">Picturesque Seychelles </h3>
                      <p class="card-text"><b>3 Nights / 4 Days</b></p>
        <ol class="breadcrumb">
          <!-- <li class="breadcrumb-item"><a href="index.php">Home</a></li> -->
          <li class="breadcrumb-item"><a href="../index.php"> Seychelles  Home</a></li>
          <li class="breadcrumb-item" aria-current="page">Picturesque Seychelles </li>
        </ol>
