            ...
            <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -20%" data-bs-smooth-scroll="true" class="scrollspy-example bg-body-tertiary p-3 rounded-2" tabindex="0" style="border: 1px solid navajowhite;">
              ...
              <h4>Itinerary:</h4>
                  <ul style="text-align: justify;">
                    <li><b>Day 1: Arrival in Almaty � City Orientation Tour</b></li>
  <p>
    Arrive at <b>Almaty International Airport</b> and meet our representative for a warm welcome. Proceed to your hotel for check-in and some rest.
    In the afternoon, explore the scenic city of apples � Almaty. Visit <b>Independence Square</b>, <b>Republic Palace</b>, and the <b>Monument of Freedom</b>. Enjoy a relaxing evening at <b>Panfilov Park</b> and admire the stunning <b>Zenkov Cathedral</b>, one of the tallest wooden churches in the world.
    <b>Overnight stay:</b> Almaty
  </p>

  <li><b>Day 2: Shymbulak Ski Resort & Medeu Valley Excursion</b></li>
  <p>
    After breakfast, head to the <b>Medeu Ice Skating Rink</b> � the highest-altitude skating rink in the world. Continue by cable car to the <b>Shymbulak Ski Resort</b>, surrounded by the breathtaking <b>Tien Shan Mountains</b>.
    Enjoy skiing (in season), snow activities, or relax at a mountain caf�. Return to the city in the evening and enjoy free time.
    <b>Overnight stay:</b> Almaty
  </p>

  <li><b>Day 3: Big Almaty Lake & Falcon Show</b></li>
  <p>
    Start your day with a drive to <b>Big Almaty Lake</b>, located at 2,500 meters above sea level. Marvel at its turquoise waters and mountain scenery.
    Later, enjoy a <b>Kazakh Falcon Hunting Show</b>, where trained falcons demonstrate ancient hunting skills. Return to Almaty and relax at leisure.
    <b>Overnight stay:</b> Almaty
  </p>

  <li><b>Day 4: Kok Tobe Hill & Night View of Almaty</b></li>
  <p>
    After breakfast, visit <b>Kok Tobe Hill</b> via cable car for panoramic city views. See the <b>Beatles Monument</b>, browse souvenir shops, and enjoy the observation deck.
    In the evening, enjoy shopping and dining at <b>Dostyk Plaza</b> or <b>Mega Mall</b>. Take in the night lights of Almaty before returning to your hotel.
    <b>Overnight stay:</b> Almaty
  </p>

  <li><b>Day 5: Free Day for Leisure or Optional Tours</b></li>
  <p>
    After breakfast, spend the day at leisure or choose from the following optional tours:
    � <b>Charyn Canyon Tour</b> � Explore the �Mini Grand Canyon of Central Asia�
    � <b>Issyk Lake & Museum Tour</b> � A tranquil mountain lake with cultural insights
    Evening at leisure � relax or explore local cafes and nightlife.
    <b>Overnight stay:</b> Almaty
  </p>

  <li><b>Day 6: Departure from Almaty</b></li>
  <p>
    After breakfast, check out from the hotel. Transfer to <b>Almaty International Airport</b> for your departure with wonderful memories of Kazakhstan.
    <b>? Safe travels!</b>
��</p>
                  </ul>  
            </div>
          ...
          <div class="col-lg-4 d-flex align-items-center basic_pack">
            ...
            <div class="col">
                <div class="card text-center mb-3 package-card">
                    <div class="card-body">
                      <h3 class="card-title">Kazhakasthan_Almaty</h3>
                      <p class="card-text"><b>5 Nights / 6 Days</b></p>
        <ol class="breadcrumb">
          <!-- <li class="breadcrumb-item"><a href="index.php">Home</a></li> -->
          <li class="breadcrumb-item"><a href="../index.php">Kazhakasthan Home</a></li>
          <li class="breadcrumb-item" aria-current="page">Kazhakasthan_Almaty</li>
        </ol>
