...
<div class="container package p-0">
  <div class="row pack_mobile">
    <div class="col-lg-12 pic p-0">
      <div id="carouselExampleSlidesOnly" class="carousel slide d-flex" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active"><img src="../../../../itinerary-placeholder-tour.svg" class="d-block w-100" alt="Gujarat"></div>
          <div class="carousel-item"><img src="../../../../itinerary-placeholder-tour.svg" class="d-block w-100" alt="Gujarat"></div>
          <div class="carousel-item"><img src="../../../../itinerary-placeholder-tour.svg" class="d-block w-100" alt="Gujarat"></div>
        </div>
      </div>
    </div>
      ...
      <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -20%" data-bs-smooth-scroll="true" class="scrollspy-example bg-body-tertiary p-3 rounded-2" tabindex="0" style="border: 1px solid navajowhite;">
        <div class="itinerary_list">
          ...
          <ul style="text-align: justify;">
            <li><b>DAY 1: ARRIVAL AT AHMEDABAD - DWARKA</b></li>
            <p>Upon arrival at Ahmedabad, you will be warmly received and picked up from the airport or railway station. Begin your scenic drive towards Dwarka. Check in to the hotel and enjoy an overnight stay in Dwarka.</p>
            <li><b>DAY 2: DWARKA &amp; BEYT DWARKA SIGHTSEEING</b></li>
            <p>After breakfast, visit Dwarkadhish Temple, Beyt Dwarka, Nageshwar Jyotirlinga, Rukmini Devi Temple, and Gomti Ghat. Return to the hotel for an overnight stay in Dwarka.</p>
            <li><b>DAY 3: DWARKA - PORBANDAR - SOMNATH</b></li>
            <p>After breakfast, check out and drive towards Porbandar to visit Kirti Mandir and Sudama Temple. Continue to Somnath and enjoy darshan at the Somnath Temple. Overnight stay in Somnath.</p>
            <li><b>DAY 4: SOMNATH - SASAN GIR</b></li>
            <p>After breakfast, another darshan at Somnath Temple and local sightseeing, then proceed to Gir National Park. Check in to the resort and stay overnight amidst nature.</p>
            <li><b>DAY 5: SASAN GIR - VADODARA</b></li>
            <p>Optional Gir safari in the morning, then proceed towards Vadodara. Check in to the hotel and stay overnight.</p>
            <li><b>DAY 6: VADODARA - STATUE OF UNITY</b></li>
            <p>After breakfast, proceed to the Statue of Unity and explore Valley of Flowers, Viewing Gallery, Jungle Safari, and Ekta Cruise. Overnight stay in Kevadia / Statue of Unity area.</p>
            <li><b>DAY 7: STATUE OF UNITY - AHMEDABAD</b></li>
            <p>Return to Ahmedabad and visit Sabarmati Ashram, Adalaj Stepwell, and Kankaria Lake. Overnight stay in Ahmedabad.</p>
            <li><b>DAY 8: AHMEDABAD LOCAL SIGHTSEEING &amp; DEPARTURE</b></li>
            <p>Enjoy remaining sightseeing or shopping, then transfer to Ahmedabad Airport or Railway Station for onward journey.</p>
          </ul>
        </div>
        <hr>
    ...
    <div class="col-lg-4 d-flex align-items-center basic_pack">
      ...
      <div class="col"><div class="card text-center mb-3 package-card"><div class="card-body"><h3 class="card-title">Gujarat</h3><p class="card-text"><b>7 Nights / 8 Days</b></p><nav class="container" aria-label="breadcrumb"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="../index.php">Home</a></li><li class="breadcrumb-item active" aria-current="page">Gujarat</li></ol></nav></div></div></div>
      <div class="col d-flex align-items-center justify-content-center"><h5><b>Need Help</b></h5><p>Call: +91 72004 49904</p><p>Email: Info@grandskholidays.com</p></div>
    </div>
  </div>
</div>
