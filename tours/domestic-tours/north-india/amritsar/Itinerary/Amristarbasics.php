            ...
            <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -20%" data-bs-smooth-scroll="true" class="scrollspy-example bg-body-tertiary p-3 rounded-2" tabindex="0" style="border: 1px solid navajowhite;">
              ...
              <h4>Itinerary:</h4>
                  <ul style="text-align: justify;">
                      <li><b>DAY 1: Arrival in Amritsar</b></li>
                      <p>Arrive at Amritsar Railway Station or Airport. On arrival meet and greet by our representative who will take you to the hotel. Check in to the hotel. Visit the Golden Temple (Harmandir Sahib), a sacred Sikh shrine Overnight stay at hotel.</p>
                      <li><b>DAY 2:  Amritsar (Departure)</b></li>
                      <p>Morning breakfast at hotel. Visit the Jallianwala Bagh, a historic site and memorial. Explore the Akal Takht, a sacred Sikh shrine . Overnight stay at hotel.</p>
          ...
          <div class="col-lg-4 d-flex align-items-center basic_pack">
            ...
            <div class="col">
                <div class="card text-center mb-3 package-card">
                    <div class="card-body">
                      <h3 class="card-title">AMRISTAR</h3>
                      <p class="card-text"><b>1 Nights / 2 Days</b></p>
                      <!-- row -->
                        <nav class="container" aria-label="breadcrumb">
                          <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Amristar</li>
                          </ol>
                        </nav>
                      <!--<p class="card-text">PORTBLAIR - 2 NIGHTS<br> HAVELOCK - 1 NIGHT</p>-->
