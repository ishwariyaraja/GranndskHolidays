    ...
    <div class="col-lg-12 pic p-0">
      <div id="carouselExampleSlidesOnly" class="carousel slide d-flex" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active"><img src="../../../../itinerary-placeholder-tour.svg" class="d-block w-100" alt="Hyderabad"></div>
          <div class="carousel-item"><img src="../../../../itinerary-placeholder-tour.svg" class="d-block w-100" alt="Hyderabad"></div>
          <div class="carousel-item"><img src="../../../../itinerary-placeholder-tour.svg" class="d-block w-100" alt="Hyderabad"></div>
        </div>
      </div>
    </div>
      ...
      <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -20%" data-bs-smooth-scroll="true" class="scrollspy-example bg-body-tertiary p-3 rounded-2" tabindex="0" style="border: 1px solid navajowhite;">
        <div class="itinerary_list">
          ...
          <ul style="text-align: justify;">
            <li><b>DAY 1: ARRIVAL HYDERABAD &amp; LUMBINI PARK</b></li>
            <p>Arrival at Hyderabad, proceed to the hotel, and in the evening visit Lumbini Park, Necklace Road, Hussain Sagar Lake, and attend the laser show. Night stay in Hyderabad.</p>
            <li><b>DAY 2: MANTRALAYAM TEMPLE</b></li>
            <p>After breakfast, proceed to Mantralayam Raghavendra Swamy Temple for holy darshan and return to Hyderabad. Night stay in Hyderabad.</p>
            <li><b>DAY 3: HYDERABAD / SECUNDERABAD CITY TOUR</b></li>
            <p>After breakfast, continue sightseeing with Nagarjuna Sagar Lake on the way if time permits, followed by Birla Mandir, Salarjung Museum, Charminar, and Mecca Masjid. Night stay in Hyderabad.</p>
            <li><b>DAY 4: RAMOJI FILM CITY &amp; DEPARTURE</b></li>
            <p>After breakfast proceed to Ramoji Film City. In the evening, transfer to the airport for departure.</p>
          </ul>
        </div>
        <hr>
      ...
      <div class="col">
        <div class="card text-center mb-3 package-card">
          <div class="card-body">
            ...
            <nav class="container" aria-label="breadcrumb"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="../index.php">Home</a></li><li class="breadcrumb-item active" aria-current="page">Hyderabad</li></ol></nav>
          </div>
        </div>
      </div>
