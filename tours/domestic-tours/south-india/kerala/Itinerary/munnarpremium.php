      ...
      <div id="carouselExampleSlidesOnly" class="carousel slide d-flex" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../Kerala4.jpg" class="d-block w-100" alt="Munnar">
          </div>
        </div>
      </div>    
        </div>
            ...
            <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -20%" data-bs-smooth-scroll="true" class="scrollspy-example bg-body-tertiary p-3 rounded-2" tabindex="0" style="border: 1px solid navajowhite;">
              ...
              <h4>Itinerary:</h4>
                  <ul style="text-align: justify;">
                      ...
                      <li><b>DAY 3: Munnar - Alappey HB</b></li>
                      ...
                      <li><b>DAY 4: Cochin drop with Sightseeing</b></li>
                      <p>Departure to your hometown. Here starts the last day, after breakfast we will checkout from the hotel and back to Cochin. Cab driver will take you to Cochin sightseeing which may include Fort Cochin, Navy Museum, Mattanchery, Jewish Synagogue, St Francis Church, Chinese Fishing Net, Santa Cruz Basilica, Marine Drive, Marine Walkway, boating, and shopping at Lulu Mall. Fly back to your hometown with good memories of Kerala trip.</p>
                  </ul>  
            </div><hr>
    ...
    <div class="col-12 col-md-6 mb-3">
      ...
      <nav class="container" aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Munnar</li>
        </ol>
      </nav>
