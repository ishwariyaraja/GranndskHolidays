          ...
          <div class="container col-lg-7 d-flex cont">
            ...
            <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -20%" data-bs-smooth-scroll="true" class="scrollspy-example bg-body-tertiary p-3 rounded-2" tabindex="0" style="border: 1px solid navajowhite;">
              ...
              <h4>Itinerary:</h4>
                  ...
                  <li><b>Day 01 - Airport / Pinnawala / Kandy (Approximately 04 Hours Drive)</b></li>
      <p>Arrival at Colombo Airport. Proceed to Kandy en route Pinnawala Elephant Orphanage, Cultural Show. Evening check-in at hotel. Dinner and overnight stay at hotel.</p>
  
    <li><b>Day 02 - Kandy / Ramboda / Nuwara Eliya (Approximately 03 Hours Drive)</b></li>
      <p>After breakfast, check out from hotel. En route visit Temple of the Tooth, Gem Museum, Wood Carving, Batik Shopping. Transfer to Nuwara Eliya via Ramboda Hanuman Temple, Ramboda Falls. Check-in at hotel. Dinner and overnight stay at hotel.</p>
  
    <li><b>Day 03 - Nuwara Eliya / Bentota (Approximately 07 Hours Drive)</b></li>
      <p>After breakfast, check out from hotel. Visit Gregory Lake, Seetha Amman Temple, Hakgala Garden (optional). Transfer to Colombo via Tea Factory visit, Spice Garden, and shopping at Colombo. Check-in at hotel. Dinner and overnight stay at hotel.</p>
    
    <li><b>Day 04 - Bentota Water Sports Activities</b></li>
      <p>After breakfast, day excursion to Bentota. Visit Turtle Hatchery, Madu River, Boat Safari, and optional water sports. Colombo city tour in the evening. Dinner and overnight stay at Colombo hotel.</p>


    <li><b>Day 05 - Colombo / Trichy</b></li>
      <p>After breakfast, check out from hotel. Proceed to Colombo Airport with lots of sweet memories. Drop at Airport at 11:30 AM.</p>
  

    <li><b>Day 06 - Colombo / Airport (Approximately 01 Hour Drive)</b></li>
      <p>Check out from the hotel and transfer to the airport for your departure flight.</p>
          ...
          <div class="col-lg-4 d-flex align-items-center basic_pack">
            ...
            <div class="col">
                <div class="card text-center mb-3 package-card">
                    <div class="card-body">
                      <h3 class="card-title">Srilanka</h3>
                      <p class="card-text"><b>5 Nights / 6 Days</b></p>
        <ol class="breadcrumb">
          <!-- <li class="breadcrumb-item"><a href="index.php">Home</a></li> -->
          <li class="breadcrumb-item"><a href="../index.php">Srilanka Home</a></li>
          <li class="breadcrumb-item" aria-current="page">Srilanka</li>
        </ol>
