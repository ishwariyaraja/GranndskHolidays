...
<!-- ===== CONTENT ===== -->
   <div class="background_main">
    <img src="mala-1.jpg" alt="">
    <!-- <img src="./Images/hawaii.png"> -->
   </div>
   <hr>
   <div class="container-fluid" style="text-align: justify; width: 95%;">
   <h4> Malaysia </h4>
   <p>Malaysia, located in Southeast Asia, is a beautiful mix of modern cities, tropical islands, rainforests, and multicultural traditions. It’s known for its friendly locals, street food, and stunning architecture.Top tourist spots include Kuala Lumpur, Langkawi, Penang, Genting Highlands, Cameron Highlands, Putrajaya, Malacca, Batu Caves, Tioman Island, and Mount Kinabalu.Kuala Lumpur, the capital city, is famous for the iconic Petronas Twin Towers, vibrant shopping malls, and food streets.Langkawi is a tropical island paradise with beaches, waterfalls, and cable cars.Penang offers a mix of heritage, street art, and food heaven — especially in George Town.
Batu Caves is a sacred Hindu site with a massive golden Murugan statue and cave temples.
Cameron Highlands and Genting Highlands are cool-weather getaways with tea plantations and entertainment hubs..</p>
  </div>
<hr>
<!-- columns -->
...
<!-- Magical Thailand Packages -->
    ...
    <div class="col-lg-4 col-md-6 col-sm-12" style="display: flex; justify-content: center; align-items: center; margin: auto;"><div class="card">
       <div class="card-image" style="background-image: url(mala-2.jpg); background-size: cover;">
      </div>
      <div class="card-content tour-card-content" style="display:flex; flex-direction:column; align-items:center; justify-content:center; text-align:center; gap:12px; min-height:150px; padding:22px 18px 26px;">
        ...
        <h4 class="card-title" style="margin:0; width:100%;">Malaysia - Ipoh and Kuala Lumpur</h4>
...
<!-- standard -->
    <div class="col-lg-4 col-md-6 col-sm-12" style="display: flex; justify-content: center; align-items: center; margin: auto;"><div class="card">
      <div class="card-image" style="background-image: url(mala-3.jpg); background-size: cover;">
      </div>
      <div class="card-content tour-card-content" style="display:flex; flex-direction:column; align-items:center; justify-content:center; text-align:center; gap:12px; min-height:150px; padding:22px 18px 26px;">
   ...
   <!-- Premium -->
    <div class="col-lg-4 col-md-6 col-sm-12" style="display: flex; justify-content: center; align-items: center; margin: auto;"><div class="card">
       <div class="card-image" style="background-image: url(mala-4.jpg); background-size: cover;">
      </div>
      <div class="card-content tour-card-content" style="display:flex; flex-direction:column; align-items:center; justify-content:center; text-align:center; gap:12px; min-height:150px; padding:22px 18px 26px;">
...
<!--   Thailand Pakages-->
    <!-- basics -->
     <div class="col-lg-4 col-md-6 col-sm-12" style="display: flex; justify-content: center; align-items: center; margin: auto;"><div class="card">
      <div class="card-image" style="background-image: url(mala-5.jpg); background-size: cover;">
      </div>
      <div class="card-content tour-card-content" style="display:flex; flex-direction:column; align-items:center; justify-content:center; text-align:center; gap:12px; min-height:150px; padding:22px 18px 26px;">
        <h5 class="tour-card-pack" style="margin:0; width:100%;">Basic Package</h5>
        <h4 class="card-title" style="margin:0; width:100%;">Malaysia - Kuala Lumpur and Genting</h4>
...
<!--Standard-->
    <div class="col-lg-4 col-md-6 col-sm-12" style="display: flex; justify-content: center; align-items: center; margin: auto;"><div class="card">
        <div class="card-image" style="background-image: url(mala-6.jpg); background-size: cover;">
      </div>
      <div class="card-content tour-card-content" style="display:flex; flex-direction:column; align-items:center; justify-content:center; text-align:center; gap:12px; min-height:150px; padding:22px 18px 26px;">
        <h5 class="tour-card-pack" style="margin:0; width:100%;">Standard Package</h5>
        <h4 class="card-title" style="margin:0; width:100%;">Malaysia - Kuala Lumpur and Genting</h4>
   ...
   <!-- Premium -->
    <div class="col-lg-4 col-md-6 col-sm-12" style="display: flex; justify-content: center; align-items: center; margin: auto;"><div class="card">
          <div class="card-image" style="background-image: url(mala-7.jpg); background-size: cover;">
      </div>
      <div class="card-content tour-card-content" style="display:flex; flex-direction:column; align-items:center; justify-content:center; text-align:center; gap:12px; min-height:150px; padding:22px 18px 26px;">
        <h5 class="tour-card-pack" style="margin:0; width:100%;">Premium Package</h5>
        <h4 class="card-title" style="margin:0; width:100%;">Malaysia - Kuala Lumpur and Genting</h4>
...
<div class="container" style="margin-top: 35px;">
  <h1>Frequently Asked Questions - Malaysia</h1>
  <div class="faq">
    <div class="faq-item">
        <h2 class="faq-question">1.What’s the best time to visit Malaysia?</h2>
        <div class="faq-answer">
            <p>TNovember to March – Pleasant and dry season. Avoid June–August (rainy in some areas) </p>
        </div>
    </div>

    <div class="faq-item">
        <h2 class="faq-question">2.How to travel from India to Malaysia?</h2>
        <div class="faq-answer">
            <p>Direct flights to Kuala Lumpur (KUL) from Chennai, Bangalore, Kochi, Mumbai, etc.Airlines: AirAsia, Malaysia Airlines, Batik Air
    ...
    <div class="faq-item">
        <h2 class="faq-question">3.Do Indians need a visa for Malaysia?</h2>
        <div class="faq-answer">
            <p>Yes, Indian citizens need a Malaysia eVisa or eNTRI.
        </div>
    </div>

    <div class="faq-item">
        <h2 class="faq-question">4.What currency is used in Malaysia?</h2>
        <div class="faq-answer">
            <p>Malaysian Ringgit (MYR or RM)1 MYR ≈ ₹18 (may vary) </p>
        </div>
    </div>

    <div class="faq-item">
        <h2 class="faq-question">5.Where to stay in Malaysia?</h2>
        <div class="faq-answer">
            <p>Kuala Lumpur – Petronas Towers, nightlife, malls,Langkawi – Beaches & islands,Penang – Food, culture,Genting Highlands – Hill resort, casino.</p>
        </div>
    </div>

    <div class="faq-item">
        <h2 class="faq-question">6.What are the top attractions in Malaysia?</h2>
        <div class="faq-answer">
            <p>Petronas Twin Towers (KL),Batu Caves,Langkawi Sky Bridge,Genting Highlands,KL Tower,Sunway Lagoon Theme Park,Penang Street Art & food.</p>
        </div>
    </div>

    <div class="faq-item">
        <h2 class="faq-question">7.What to pack for Malaysia trip?</h2>
        <div class="faq-answer">
            <p>Passport + visa printout,Light clothes (hot & humid weather),Umbrella/raincoat (sudden showers),Power adapter (Type G – UK plug)Sunglasses, sunscreen.</p>
        </div>
    </div>

    <div class="faq-item">
        <h2 class="faq-question">8.What to buy in Malaysia?</h2>
        <div class="faq-answer">
            <p>Chocolates (cheap in Langkawi duty-free),Electronics,Malaysian Batik clothes,Local snacks, souvenirs</p>
        </div>
    </div>
