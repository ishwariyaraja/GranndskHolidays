...
<!-- ===== CONTENT ===== -->
      ...
      <div id="carouselExampleSlidesOnly" class="carousel slide d-flex" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item d-flex active" style="margin:auto; justify-content:center; align-items:center;">
            ...
            <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -20%" data-bs-smooth-scroll="true" class="scrollspy-example bg-body-tertiary p-3 rounded-2" tabindex="0" style="border: 1px solid navajowhite;">
              ...
              <h4>Itinerary:</h4>
                  <ul style="text-align: justify;">
                    <li><b>Day 1: Arrival in Sydney � Sydney Harbour Cruise</b></li>
  <p>Welcome to stylish Sydney � Australia�s largest city known for its vibrant life, multiculturalism, and world-class dining experiences. This afternoon, enjoy a spectacular cruise to Middle Harbour. Admire magnificent waterfront homes, scenic parklands, and panoramic harbour views. A must-do experience that introduces you to the spirit of Sydney.</p>

  <li><b>Day 2: Sydney Highlights, Bondi Beach & Sydney Opera House</b></li>
  <p>Discover Sydney�s rich history and stunning architecture. Drive through iconic areas like The Rocks, Circular Quay, Chinatown, Darling Harbour, Kings Cross, and Double Bay. Enjoy free time at the world-famous Bondi Beach (morning tea at own expense). In the afternoon, explore the interior of the architectural marvel � the Sydney Opera House � with a guided tour that brings this performing arts hub to life.</p>

  <li><b>Day 3: Blue Mountains & Wildlife Park Tour</b></li>
  <p>Visit Featherdale Wildlife Park and interact with native animals like kangaroos, crocodiles, and koalas. Explore the Blue Mountains, stopping at Katoomba and viewing the stunning Jamison and Megalong Valleys. Ride the world�s steepest railway (own expense) and view the famous Three Sisters rock formation. End your day with a Rivercat cruise along the Parramatta River back to Circular Quay.</p>

  <li><b>Day 4: Sydney to Uluru (Ayers Rock)</b></li>
  <p>Fly from Sydney to Ayers Rock (airfare not included). Upon arrival, transfer to your accommodation. Experience the majesty of the Red Centre, surrounded by ancient landscapes and Aboriginal culture. Overnight in Uluru.</p>

  <li><b>Day 5: Uluru Sunrise, Base Tour & Kata Tjuta (Olgas)</b></li>
  <p>Wake early to watch Uluru glow with the sunrise. Tour the base of the rock and visit the Mutitjulu Waterhole, viewing Aboriginal rock art along the way. Learn about the region�s flora, fauna, and history. Visit the Cultural Centre before heading to Kata Tjuta for a walk through Walpa Gorge. End your day watching the sunset over Uluru with wine and snacks.</p>

  <li><b>Day 6: Uluru to Cairns</b></li>
  <p>Optional experiences this morning include a scenic helicopter flight or Harley Davidson ride (own expense). Later, transfer to Ayers Rock Airport for your flight to Cairns (airfare not included). On arrival, transfer to your hotel and rest. Overnight in Cairns.</p>

  <li><b>Day 7: Great Barrier Reef Cruise</b></li>
  <p>Embark on a full-day reef adventure to the edge of Australia�s continental shelf. Explore the vibrant underwater world of the Great Barrier Reef � one of the seven natural wonders of the world. Snorkel, dive, or view the reef from a semi-submersible or underwater observatory. Morning and afternoon tea included. Return to your hotel for an overnight stay.</p>

  <li><b>Day 8: Kuranda Scenic Rail, Skyrail & Hartley�s Crocodile Adventures</b></li>
  <p>Start your day with the Kuranda Scenic Railway journey through rainforest and past stunning waterfalls. After exploring Kuranda, glide above the treetops with Skyrail Rainforest Cableway. Later, visit Hartley�s Crocodile Adventures, where you�ll meet crocodiles and other native species in North Queensland�s best wildlife park. Return to Cairns in the evening.</p>
                      ...
                      <div class="col d-flex p-0">
                        <div class="col-5">
                          ...
                          <ul>
                            ...
                            <li>Pickup & Drop</li>
                            <li>3* Hotel</li>
                            <li>Double or twin Share</li>
                            <li>Breakfast</li>
                            <li>Transport for Sightseeing</li>
            ...
            <div class="col">
                <div class="card text-center mb-3 package-card">
                    <div class="card-body">
                      ...
                      <p class="card-text"><b>8 Nights / 9 Days</b></p>
        <ol class="breadcrumb">
