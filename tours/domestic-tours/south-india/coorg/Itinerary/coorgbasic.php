...
<!-- ===== CONTENT ===== -->
      ...
      <div id="carouselExampleSlidesOnly" class="carousel slide d-flex" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../2.jpg" class="d-block w-100" alt="Mysore & Coorg">
          </div>
          <div class="carousel-item">
            <img src="../3.jpg" class="d-block w-100" alt="Mysore & Coorg">
          </div>
          <div class="carousel-item">
            <img src="../4.jpg" class="d-block w-100" alt="Mysore & Coorg">
          </div>
        </div>
      </div>    
        </div>
  ...
  <ul style="text-align: justify; list-style-type: none; padding-left: 0;">
    <li><b>DAY 1: Arrival in Mysore - Local Sightseeing - Drive to Coorg</b></li>
    <p>Upon arrival in Mysore, you will be picked up and begin your day with a visit to the grand Mysore Palace, one of India's most magnificent royal residences known for its intricate architecture and rich history. Continue to the serene Chamundi Hills, where you can seek blessings at the Chamundeshwari Temple and enjoy panoramic views of the city. On the way down, stop at the iconic Nandi Statue, a massive monolithic sculpture. Later, explore the beautiful St. Philomena's Church, an impressive neo-gothic structure. Proceed to the lush and well-maintained Brindavan Gardens, famous for its musical fountain show in the evening. If time permits, you may also visit the Mysore Zoo, one of the oldest and well-kept zoos in India. After a fulfilling day of sightseeing, return to your hotel in Mysore for an overnight stay.</p>
    <p>Meals (Dinner)</p>
    
    <li><b>DAY 2: Coorg Full Day Sightseeing</b></li>
    <p>After breakfast, check out from your hotel and begin your scenic drive towards Coorg, also known as the &ldquo;Scotland of India&rdquo;. En route, visit the sacred Namdroling Monastery (Golden Temple) at Bylakuppe, a major Tibetan settlement known for its stunning golden statues and peaceful ambiance. Continue your journey through lush greenery and coffee plantations as you arrive in Coorg. After check-in, head out to explore the famous Raja's Seat, a charming viewpoint that offers breathtaking sunset views over the hills and valleys. You can also visit the nearby Madikeri Fort, a historic structure that reflects the region's past. Spend the evening at leisure soaking in the cool climate and tranquil surroundings before returning to your hotel for an overnight stay in Coorg.</p>
    <p>Meals (Breakfast &amp; Dinner)</p>
    
    <li><b>DAY 3: Coorg Sightseeing - Departure</b></li>
    <p>After breakfast, check out from your hotel and proceed for a half-day sightseeing tour of Coorg. Start with a visit to the stunning Abbey Falls, surrounded by coffee plantations and spice estates, offering a refreshing and scenic experience. Next, visit the sacred Talacauvery, the origin point of the River Cauvery, located amidst the Brahmagiri hills, followed by a stop at the nearby Bhagamandala Temple, a revered pilgrimage site. If time allows, you can also explore a local coffee plantation to understand Coorg's famous coffee culture. After completing the sightseeing, you will be dropped off at your onward destination, concluding your pleasant journey through Mysore and Coorg.</p>
    <p>Meals (Breakfast)</p>
  </ul>
</div>
<hr>
          ...
          <div class="col-lg-4 d-flex align-items-center basic_pack">
            ...
            <div class="col">
                <div class="card text-center mb-3 package-card">
                    <div class="card-body">
                      <h3 class="card-title">Mysore & Coorg</h3>
                      <p class="card-text"><b>2 Nights / 3 Days</b></p>
                      <nav class="container" aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
          <li class="breadcrumb-item active" aria-current="page">Mysore & Coorg</li>
        </ol>
      </nav>
