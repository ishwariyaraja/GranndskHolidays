      ...
      <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -20%" data-bs-smooth-scroll="true" class="scrollspy-example bg-body-tertiary p-3 rounded-2" tabindex="0" style="border: 1px solid navajowhite;">
        <div class="itinerary_list">
          ...
          <ul style="text-align: justify;">
            <li><b>DAY 1: DELHI - HARIDWAR</b></li>
            <p>Arrive at Delhi airport or railway station and drive to Haridwar. If time permits, visit Mansa Devi Temple, Chandi Devi Temple, Daksha Mahadev Temple, and Har Ki Pauri for Ganga Aarti. Overnight stay in Haridwar.</p>
            <li><b>DAY 2: HARIDWAR - GUPTKASHI</b></li>
            <p>After breakfast, drive straight to Guptkashi. On arrival check in to the hotel and rest. Overnight stay in Guptkashi.</p>
            <li><b>DAY 3: GUPTKASHI - KEDARNATH</b></li>
            <p>Proceed to Sonprayag and Gaurikund, then continue to Kedarnath by trek, pony, palki, or helicopter option. Visit Kedarnath Temple and stay overnight at Kedarnath.</p>
            <li><b>DAY 4: KEDARNATH - GUPTKASHI</b></li>
            <p>After morning darshan and pooja, trek back to Gaurikund and return to Guptkashi. Night halt in Guptkashi.</p>
            <li><b>DAY 5: GUPTKASHI - BADRINATH</b></li>
            <p>Drive to Badrinath via Joshimath. Check in to the hotel and visit Badrinath Temple in the evening. Overnight stay in Badrinath.</p>
            <li><b>DAY 6: BADRINATH - RUDRAPRAYAG / KIRTINAGAR</b></li>
            <p>After morning darshan and sightseeing around Mana, Vyas Gufa, Maatamoorti, Charanpaduka, Bhimkund, and Saraswati River, drive to Rudraprayag or Kirtinagar. Overnight stay.</p>
            <li><b>DAY 7: RUDRAPRAYAG / KIRTINAGAR - RISHIKESH</b></li>
            <p>Drive to Rishikesh and visit Ram Jhula, Laxman Jhula, Triveni Ghat, Bharat Mandir, and Parmarth Ashram for Ganga Aarti. Overnight stay in Rishikesh.</p>
            <li><b>DAY 8: RISHIKESH - DELHI DEPARTURE</b></li>
            <p>After breakfast, drive back to Delhi and transfer to the airport or railway station for onward journey.</p>
          </ul>
        </div>
        <hr>
        <div class="inc_exc" id="scrollspyHeading2">
          ...
          <div class="row">
            <div class="col-12 col-md-6 mb-3"><div style="padding: 10px; border-radius: 5px;"><h5>Inclusion:</h5><hr><ul><li>Air Ticket</li><li>Airport pickup &amp; drop</li><li>3 Star Hotel - Deluxe Room</li><li>Meals (Breakfast &amp; Dinner)</li><li>A/C private Vehicle for sightseeing</li><li>Tour guide</li><li>Travel Insurance</li></ul></div></div>
