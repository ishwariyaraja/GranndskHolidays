            ...
            <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -20%" data-bs-smooth-scroll="true" class="scrollspy-example bg-body-tertiary p-3 rounded-2" tabindex="0" style="border: 1px solid navajowhite;">
              ...
              <h4>Itinerary:</h4>
                  <ul style="text-align: justify;">
                      <li><b>DAY 1: Arrived at Airport</b></li>
                      ...
                      <li><b>DAY 3: Darjeeling to Kalimpong</b></li>
                      ...
                      <li><b>DAY 4:  Kalimpong to Gangtok</b></li>
                      <p>After breakfast transfer to Gangtok (5,500 ft.). On arrival check-in to your hotel. Afternoon proceed for a city tour visiting Flower show, Cottage Industry and Handicraft Centre, Institute of Tibetology, Dro-dul Chorten, Enchey Monastery & Banjakhri Falls (maximum 3-4 hours). Overnight stay at Gangtok.</p>
                      <li><b>DAY 5:  Gangtok Sightseeing</b></li>
