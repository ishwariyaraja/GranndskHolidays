    ...
    <div class="col-lg-12 pic p-0">
      <div id="carouselExampleSlidesOnly" class="carousel slide d-flex" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active"><img src="../../../../itinerary-placeholder-tour.svg" class="d-block w-100" alt="Manali"></div>
          <div class="carousel-item"><img src="../../../../itinerary-placeholder-tour.svg" class="d-block w-100" alt="Manali"></div>
          <div class="carousel-item"><img src="../../../../itinerary-placeholder-tour.svg" class="d-block w-100" alt="Manali"></div>
        </div>
      </div>
    </div>
      ...
      <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -20%" data-bs-smooth-scroll="true" class="scrollspy-example bg-body-tertiary p-3 rounded-2" tabindex="0" style="border: 1px solid navajowhite;">
        <div class="itinerary_list">
          ...
          <ul style="text-align: justify;">
            <li><b>DAY 1: DELHI TO MANALI - ARRIVAL &amp; TRANSFER</b></li>
            <p>On arrival at Delhi airport or railway station, you will be welcomed by our representative and proceed to Manali by road. Manali is a beautiful hill station located in the Beas River Valley. Upon reaching, check in at the hotel and take some rest. Dinner at the hotel and overnight stay in Manali.</p>
            <li><b>DAY 2: MANALI - FULL DAY SIGHTSEEING</b></li>
            <p>After breakfast, set out on a city tour of Manali. Your itinerary includes visits to the Hadimba Devi Temple, Club House, Van Vihar, Vashisht Bath, and the Tibetan Monastery. In the evening, take a leisurely walk along Mall Road. Return to your hotel for dinner and a restful overnight stay.</p>
            <li><b>DAY 3: MANALI TO SOLANG VALLEY - EXCURSION</b></li>
            <p>After breakfast, set out for Solang Valley, known for adventure activities like paragliding, zorbing, ATV rides, horseback riding, and trail rides. During snowfall, access may depend on road conditions and sightseeing may be limited to Barrier Point. Rohtang Pass or Atal Tunnel sightseeing can be arranged at additional cost and subject to local permissions. Return to the hotel for dinner and overnight stay.</p>
            <li><b>DAY 4: DEPARTURE</b></li>
            <p>After breakfast, head to Delhi Airport or railway station for your journey back home. As your holiday concludes, we look forward to staying connected with you on Facebook and Instagram.</p>
          </ul>
        </div>
        <hr>
            ...
            <div class="col-12 col-md-6 mb-3">
              <div style="padding: 10px; border-radius: 5px;">
                ...
                <ul>
                  ...
                  <li>4 Star Hotel - Premium Room</li>
          ...
          <div class="card-body">
            ...
            <nav class="container" aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Manali</li>
              </ol>
            </nav>
          </div>
        </div>
