            ...
            <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -20%" data-bs-smooth-scroll="true" class="scrollspy-example bg-body-tertiary p-3 rounded-2" tabindex="0" style="border: 1px solid navajowhite;">
              ...
              <h4>Itinerary:</h4>
                  <ul style="text-align: justify;">
                    <li>
      <b>Day 1: Arrival</b> </li>
      <p>Upon your arrival at Mahe International airport, you will be welcomed by the agent's representative and will be transferred to your hotel. You will have the whole day for recreation. Overnight stay at the hotel.</p>
   

    <li>
      <b>Day 2: Mahe Island Tour</b> </li>
      <p>Have a luscious breakfast and proceed towards the Mahe Island tour that starts with a city visit in Mahe. It's an extraordinary chance to visit famous tourist attractions of Mahe the likes of which include the Victoria Clock Tower and the colorful Sir Selwyn-Selwyn Clarke Market place.
      A short stop at the notable Mission Lodge lets you witness its remnants and, obviously, a fantastic perspective on the ocean coast. This Seychelles visit agenda lets you visit spice and flavor garden. Likewise visit the nearby specialty town, get yourself some incredible keepsakes and be astounded by engineering and Creole culture. As the day closes, you will be moved back to your hotel for an overnight stay.</p>
   

    <li>
      <b>Day 3: Water Sports</b> </li>
      <p>Relish an early morning breakfast at the resort. Today you can indulge in some water sports at Mah̩. Choose from activities like - scuba diving, snorkelling, glass bottom boat riding, surfing, kitesurfing, windsurfing, sailing, and paragliding (at an extra cost). In the evening, head back to the hotel for overnight stay.</p>
   

    <li>
      <b>Day 4: Recreation and Night Life</b> </li>
      <p>Have a delicious breakfast and proceed to enjoy this leisure day, just as you want. This trip is incomplete without enjoying its nightlife. There is no shortage of casinos, dance clubs or bars. So pick anyone and experience the nightlife until you feel satisfied. Afterward, return back to the hotel for overnight stay.</p>
   

    <li>
      <b>Day 5: Departure</b> </li>
      <p>After breakfast, you will be transferred to the airport for your return journey.</p>
          ...
          <div class="col-lg-4 d-flex align-items-center basic_pack">
            ...
            <div class="col">
                <div class="card text-center mb-3 package-card">
                    <div class="card-body">
                      <h3 class="card-title"> Enthralling Seychelles </h3>
                      <p class="card-text"><b>4 Nights / 5 Days</b></p>
        <ol class="breadcrumb">
          <!-- <li class="breadcrumb-item"><a href="index.php">Home</a></li> -->
          <li class="breadcrumb-item"><a href="../index.php"> Seychelles Home</a></li>
          <li class="breadcrumb-item" aria-current="page"> Enthralling Seychelles </li>
        </ol>
