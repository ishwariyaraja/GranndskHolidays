  ...
  <div class="container package p-0">
      ...
      <div id="carouselExampleSlidesOnly" class="carousel slide d-flex" data-bs-ride="carousel">
        <div class="carousel-inner">
          ...
          <div class="carousel-item">
            <img src="../Andaman3.png" class="d-block w-100" alt="...">
          </div>
        </div>
      </div>    
        </div>
            ...
            <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -20%" data-bs-smooth-scroll="true" class="scrollspy-example bg-body-tertiary p-3 rounded-2" tabindex="0" style="border: 1px solid navajowhite;">
                ...
                <h4>Itinerary:</h4>
                  <ul style="text-align: justify;">
                      ...
                      <p>Arrive at Port Blair, check in to the hotel and proceed for local sightseeing. Visit Corbyn's Cove Beach and the Cellular Jail, followed by the light and sound experience in the evening. Overnight stay at Port Blair.</p>
                      <li><b>DAY 2: PORT BLAIR TO HAVELOCK</b></li>
                      <p>After breakfast, take the ferry to Havelock Island and visit Radhanagar Beach, one of the most beautiful beaches in Asia. Enjoy the rest of the day at leisure and stay overnight on Havelock.</p>
                      <li><b>DAY 3: ROSS ISLAND / NORTH BAY - DEPARTURE</b></li>
                      <p>After breakfast, visit Ross Island and North Bay for sightseeing and water activities. Later, return to Port Blair and transfer to the airport for departure.</p>
                  </ul>  
            </div><hr>
