      ...
      <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -20%" data-bs-smooth-scroll="true" class="scrollspy-example bg-body-tertiary p-3 rounded-2" tabindex="0" style="border: 1px solid navajowhite;">
        <div class="itinerary_list">
          ...
          <ul style="text-align: justify;">
            <li><b>DAY 1: HYDERABAD ARRIVAL</b></li>
            <p>Arrive at Hyderabad Airport, visit Statue of Equality, and proceed to the hotel. After freshening up, visit Lumbini Park and Hussain Sagar. Overnight stay in Hyderabad.</p>
            <li><b>DAY 2: CITY SIGHTSEEING</b></li>
            <p>After breakfast, visit Salarjung Museum, Charminar, Mecca Masjid, Snow World, NTR Garden, and local shopping areas. Return to the hotel for an overnight stay.</p>
            <li><b>DAY 3: RAMOJI FILM CITY</b></li>
            <p>After breakfast, proceed to Ramoji Film City and enjoy a full-day entertainment tour. Return to the hotel for an overnight stay.</p>
            <li><b>DAY 4: CITY SIGHTSEEING</b></li>
            <p>After breakfast visit Birla Mandir, Golconda Fort, Nehru Zoological Park, and Qutub Shahi Tombs. Return to the hotel for overnight stay.</p>
            <li><b>DAY 5: DEPARTURE</b></li>
            <p>After breakfast, check out from the hotel and transfer to the airport for departure.</p>
          </ul>
        </div>
        <hr>
