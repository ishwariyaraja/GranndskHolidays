...
<!-- Jaipur Packages -------------------------------------------------------------------------------------------->
    ...
    <div class="col-lg-4 col-md-6 col-sm-12" style="display:flex; justify-content:center; align-items:center; margin:auto;"><div class="card">
      <div class="card-image" style="background-image: url(./Jaipur1.jpg); background-size: cover;">
        <p style="background-color:#000080;">2 Nights / 3 Days</p>
      </div>
      <div class="card-content">
        <h5>SK Holidays-India-Jaipur Basic Pack</h5>
          <h4 class="card-title">Trip to Jaipur </h4><hr>
          <div class="vl">
          ...
          <!-- modal -->
           <!-- Button trigger modal -->
            <div class="container d-flex justify-content-center">
              <a href="../jaipur/Itinerary/SK-Holidays_Jaipur.php"><button type="button" class="btn btn-primary" data-bs-toggle="modal">View Itinerary </button></a>
</div></div>
    </div></div>

<!-- standard -->
    <div class="col-lg-4 col-md-6 col-sm-12" style="display:flex; justify-content:center; align-items:center; margin:auto;"><div class="card">
      <div class="card-image" style="background-image: url(./Jaipur2.jpg); background-size: cover;">
        <p style="background-color:#000080;">2 Nights / 3 Days</p>
      </div>
      <div class="card-content">
        <h5>GRAND SK Holidays-India-Jaipur Standard Pack</h5>
        <div style="display: flex; justify-content: space-between;">
          <h4 class="card-title">Trip to Jaipur </h4>        
          </div><hr>
          <div class="vl">
              <div class="row d-flex align-items-start">
                <div class="col-2">
          ...
          <div class="container d-flex justify-content-center">
            <a href="../jaipur/Itinerary/SK-Holidays_Jaipur-Standard.php"><button type="button" class="btn btn-primary" data-bs-toggle="modal">View Itinerary</button></a>
          </div>
      </div>
    </div></div>
   ...
   <!-- Premium -->
    <div class="col-lg-4 col-md-6 col-sm-12" style="display:flex; justify-content:center; align-items:center; margin:auto;"><div class="card">
      <div class="card-image" style="background-image: url(./Jaipur3.jpg); background-size: cover;">
        <p style="background-color:#000080;"> 2 Nights / 3 Days</p>
      </div>
      <div class="card-content">
        <h5>GRAND SK Holidays-India-Jaipur Premium Pack</h5>
        <div style="display: flex; justify-content: space-between;">
          <h4 class="card-title">Trip to Jaipur </h4>        
          </div><hr>
          <div class="vl">
          ...
          <div class="container d-flex justify-content-center">
            <a href="../jaipur/Itinerary/SK-Holidays_Jaipur-Premium.php"><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal2">View Itinerary</button></a>
            </div>
      </div>
    </div></div>
...
<div class="container" style="margin-top: 35px;">
  <h1>FAQ - Jaipur Trip</h1>
  <div class="faq">
      <div class="faq-item">
          <h2 class="faq-question">1. When is the best time to visit Jaipur?</h2>
          <div class="faq-answer">
              <p>The best time to visit Jaipur is from October to March, when the weather is cool and ideal for exploring forts, palaces, and outdoor markets.</p>
          </div>
      </div>

      <div class="faq-item">
          <h2 class="faq-question">2. What are the must-visit attractions in Jaipur?</h2>
          <div class="faq-answer">
              <p>Top attractions include Amber Fort, City Palace, Hawa Mahal, Jantar Mantar, Jal Mahal, Nahargarh Fort, and local bazaars like Johari and Bapu Bazaar.</p>
          </div>
      </div>

      <div class="faq-item">
          <h2 class="faq-question">3. What activities can I do in Jaipur?</h2>
          <div class="faq-answer">
              <p>You can go sightseeing, take heritage walks, shop for handicrafts, try Rajasthani cuisine, enjoy light and sound shows, and attend cultural performances.</p>
          </div>
      </div>

      <div class="faq-item">
          <h2 class="faq-question">4. How do I reach Jaipur?</h2>
          <div class="faq-answer">
              <p>Jaipur is well connected by air, rail, and road. Jaipur International Airport has domestic and limited international flights. Trains and buses connect it to major cities like Delhi and Agra.</p>
          </div>
      </div>

      <div class="faq-item">
          <h2 class="faq-question">5. What are the accommodation options in Jaipur?</h2>
          <div class="faq-answer">
              <p>Jaipur offers luxury heritage hotels, mid-range stays, and budget guesthouses. You can also find homestays and boutique hotels within the old city area.</p>
          </div>
      </div>

      <div class="faq-item">
          <h2 class="faq-question">6. Do I need any permits to visit Jaipur?</h2>
          <div class="faq-answer">
              <p>No special permits are required to visit Jaipur for either Indian or foreign tourists.</p>
          </div>
      </div>
      ...
      <div class="faq-item">
          ...
          <div class="faq-answer">
              <p>Jaipur is famous for Rajasthani cuisine like dal baati churma, gatte ki sabzi, laal maas, and kachori. Don�t miss trying sweets like ghewar and mawa kachori.</p>
          </div>
      </div>
      ...
      <div class="faq-item">
          ...
          <div class="faq-answer">
              <p>Carry basic medicines, stay hydrated, avoid street food from unhygienic vendors, and wear sunscreen during the daytime as it can get sunny.</p>
          </div>
      </div>

      <div class="faq-item">
          <h2 class="faq-question">9. Is Jaipur safe for tourists?</h2>
          <div class="faq-answer">
              <p>Yes, Jaipur is generally safe for tourists. Take standard precautions, avoid deserted areas at night, and use verified local transport or app-based taxis.</p>
          </div>
      </div>
      ...
      <div class="faq-item">
          ...
          <div class="faq-answer">
              <p>The currency is Indian Rupee (INR). While cards and UPI are widely accepted, carry some cash for small vendors and market purchases.</p>
          </div>
      </div>

      <div class="faq-item">
          <h2 class="faq-question">11. How do I get around in Jaipur?</h2>
          <div class="faq-answer">
              <p>You can travel by auto-rickshaw, e-rickshaw, taxi, or hire a cab through apps like Ola and Uber. Many attractions are close enough for walking or cycling.</p>
          </div>
      </div>

      <div class="faq-item">
          <h2 class="faq-question">12. What should I pack for my Jaipur trip?</h2>
          <div class="faq-answer">
              <p>Pack light cotton clothes for summer, a shawl or jacket for winter evenings, sunglasses, sunscreen, a hat, and comfortable footwear for walking.</p>
          </div>
      </div>
  </div>
</div>
